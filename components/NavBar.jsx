...
const NavBar = ({ network, onNetworkChange }) => {
    ...
    <header className={`${styles.navbar} ${scrolled ? styles.scrolled : ""}`}>
      <div className={styles.inner}>
        ...
        <a href="/" className={styles.logo}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 129 30" className={styles.logoSvg}>
          ...
          <span className={styles.logoTag}>Network Tracker</span>
        </a>

        {/* Center nav */}
        <nav className={styles.nav}>
          <a href="#stats" className={styles.navLink}>Stats</a>
          <a href="#blobs" className={styles.navLink}>Blobs</a>
          <a href="#web" className={styles.navLink}>Web Activity</a>
        </nav>
      ...
      {menuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <a href="#blobs" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>Blobs</a>
          <a href="#web" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>Web Activity</a>
          <a
            href="https://explorer.shelby.xyz/shelbynet"
            target="_blank"
            rel="noopener noreferrer"
