    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <div className={styles.left}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 129 30" className={styles.logo}>
          ...
          <p className={styles.tagline}>Decentralized storage built for scale.</p>
          <p className={styles.copy}>© 2025 Shelby Foundation · Network Tracker</p>

          {/* Builder credit */}
          <div className={styles.builder}>
            <span className={styles.builderLabel}>Built by</span>
            <a
            ...
            >
              {/* X / Twitter icon */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={styles.xIcon} aria-hidden="true">
        ...
        <div className={styles.links}>
          <div className={styles.linkGroup}>
            <span className={styles.linkGroupTitle}>Protocol</span>
            <a href="https://docs.shelby.xyz/protocol" target="_blank" rel="noopener noreferrer">Introduction</a>
            <a href="https://docs.shelby.xyz/protocol/architecture/overview" target="_blank" rel="noopener noreferrer">Architecture</a>
            <a href="https://docs.shelby.xyz/protocol/architecture/token-economics" target="_blank" rel="noopener noreferrer">Token Economics</a>
            <a href="https://docs.shelby.xyz/protocol/architecture/white-paper" target="_blank" rel="noopener noreferrer">White Paper</a>
          </div>
          <div className={styles.linkGroup}>
            <span className={styles.linkGroupTitle}>Developers</span>
            <a href="https://docs.shelby.xyz" target="_blank" rel="noopener noreferrer">Docs</a>
            <a href="https://developers.shelby.xyz" target="_blank" rel="noopener noreferrer">Developer Portal</a>
            <a href="https://github.com/shelby/shelby-quickstart" target="_blank" rel="noopener noreferrer">Quickstart</a>
            <a href="https://github.com/shelby/examples" target="_blank" rel="noopener noreferrer">Examples</a>
          </div>
          <div className={styles.linkGroup}>
            <span className={styles.linkGroupTitle}>Community</span>
            <a href="https://x.com/shelbyserves" target="_blank" rel="noopener noreferrer">X / Twitter</a>
            <a href="https://discord.gg/shelbyserves" target="_blank" rel="noopener noreferrer">Discord</a>
            <a href="https://github.com/shelby" target="_blank" rel="noopener noreferrer">GitHub</a>
            <a href="https://github.com/shelby/feedback/issues/new/choose" target="_blank" rel="noopener noreferrer">Submit Feedback</a>
          </div>
          <div className={styles.linkGroup}>
            <span className={styles.linkGroupTitle}>Tools</span>
            <a href="https://explorer.shelby.xyz/shelbynet" target="_blank" rel="noopener noreferrer">Blob Explorer</a>
            <a href="https://docs.shelby.xyz/tools/cli" target="_blank" rel="noopener noreferrer">CLI</a>
            <a href="https://docs.shelby.xyz/tools/s3-gateway" target="_blank" rel="noopener noreferrer">S3 Gateway</a>
            <a href="https://shelby.xyz/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
